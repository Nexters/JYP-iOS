...
class TempViewController: BaseViewController {
    ...
    override func setupBind() {
        ...
        discussionButton.rx.tap
            .bind { [weak self] in
                ...
                let plannerViewController = PlannerViewController(reactor: .init(journeyId: "1"))
...
extension TempViewController: ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding {
